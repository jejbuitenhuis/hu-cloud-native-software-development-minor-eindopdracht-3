...
def test_get_card_instance_by_id(setup_dynamodb_collection):
    ...
    event = {'pathParameters': {'instance_id': '1'}, 'headers': {'Authorization': f'Bearer {generate_test_jwt()}'}}
...
def test_get_card_instance_by_id(setup_dynamodb_collection):
    ...
    # Mock API Gateway event
    event = {'pathParameters': {'instance_id': '3'}, 'headers': {'Authorization': f'Bearer {generate_test_jwt()}'}}
